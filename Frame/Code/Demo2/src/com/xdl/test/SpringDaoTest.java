...
public class SpringDaoTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("————————————————————————");
		BankAccount bankAccount = bankAccountDAO.getBankAccountByNameAndPassword("xiaoma", "123");
		...
		System.out.println("————————————————————————");
		int res = bankAccountDAO.getBankAccountByNameAndPassword("guanyu", "123").getAno();
		BankAccount bankAccount3 = new BankAccount(res, "xiaoxiaofei", "999", 123400);
